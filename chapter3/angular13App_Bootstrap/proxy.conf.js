var PROXY_CONFIG = [
  {
    ...
    logLevel: "debug",
    pathRewrite: {
      "^/coldFusion/": "http://local10.angular.learn-with.com/rest/lw3/"
    },
    changeOrigin: true
  },
  {
    ...
    logLevel: "debug",
    pathRewrite: {
      "^/java/": "http://localhost:8083/webapi/"
    }
  },
  {
    context: [
  ...
  },
  {
    ...
    pathRewrite: function (path, req) {
      ...
      let url = resultsArray[0].replace('/php/', 'http://localphp.angular.learn-with.com:8080/A12/chapter3/php/com/dotComIt/learnWith/api/')  ;
