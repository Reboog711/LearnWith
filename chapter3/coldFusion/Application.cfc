<cfcomponent displayname="ApplicationCFC" output="true" >
    ...
    <cffunction name="onApplicationStart" returntype="boolean" output="true">
        ...
        <cfset application.componentPrefix = "A12.chapter3.coldFusion.">
        <cfset RestInitApplication(expandPath('/A12/chapter3/coldFusion/com/dotComIt/learnWith/services'),"lw3")>
