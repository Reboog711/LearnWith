...
/* Why is this extra check here?  I think to make sure it is after today ignoring any relevant time stamps showing items from the same day
Anyway, I didn't describe this in the book text for Chapter 3; so dropping it out.
                                if (
