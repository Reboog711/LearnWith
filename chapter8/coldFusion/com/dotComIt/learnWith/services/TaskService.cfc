...
<cfcomponent displayname="TaskService"
    ...
    <cffunction name="completeTask" returnformat="plain" access="remote" output="true" >
        <cfargument name="taskID" type="numeric" required="true"/>
        ...
        <cfquery datasource="#application.dsn#" name="local.dataQuery"
                result="local.results">
              update tasks
              set completed = <cfqueryparam value="#arguments.completed#" cfsqltype="cf_sql_bit" >,
              <cfif completed is true>
                  dateCompleted = <cfqueryparam value="#createODBCDateTime(now())#" cfsqltype="cf_sql_timestamp" >
              <cfelse>
        ...
        <cfset local.tempObject =  createObject('component','#application.componentPrefix#com.dotComIt.learnWith.vos.TaskFilterVO')/>
