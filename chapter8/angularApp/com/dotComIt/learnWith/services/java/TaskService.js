...
angular.module('learnWith').service('TaskService', ['$http','$filter',function($http,$filter){
    ...
    function scheduleTask(task){
        ...
        if(task.dateScheduled){
            parameters.dateScheduled = dateConvert(task.dateScheduled)
        }
        return $http.put(servicePrefix + 'task/schedule',
            parameters )
    };
    ...
    function scheduleTaskList(taskArray, schedulerDate){
        ...
        var parameters = {
            ...
            dateScheduled : dateConvert(schedulerDate)
        }
        return $http.put(servicePrefix + 'task/schedule',
            parameters )
    };
    ...
    function completeTask(task){
        ...
        return $http.put(servicePrefix + 'task/complete', parameters )
    }
}]);
