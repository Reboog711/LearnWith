...
export class TaskServiceJava {
  ...
  private createTask_internal(task :TaskVO, user :UserVO): Observable<any> {
    ...
    return this.http.post(servicePrefix + 'task', parameters, this.options);
  }
  private updateTask_internal(task :TaskVO): Observable<any> {
    ...
    return this.http.put(servicePrefix + 'task', parameters, this.options);
  }
  ...
  completeTask(task :TaskVO): Observable<any> {
    ...
    return this.http.put(servicePrefix + 'task/complete', parameters, this.options);
  };
