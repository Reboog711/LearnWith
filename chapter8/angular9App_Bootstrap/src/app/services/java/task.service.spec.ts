...
import { TaskServiceJava } from './task.service';
...
describe('TaskServiceJava', () => {
  const urlString = '/java/webapi/';
  let service: TaskServiceJava;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(TaskServiceJava);
  });
  beforeEach(()=>{
  ...
  describe('loadTaskCategories() ', function () {
    it('Should load Task Categories', () => {
      ...
      let url = urlString+ 'taskCategories'
  ...
  describe('loadTask() ', function () {
    ...
    it('Should Load Completed Tasks', () => {
      ...
      let url = urlString+ 'tasks?completed=true'
      const req = httpMock.expectOne(url) ;
    ...
    it('Should Load Not Completed Tasks', () => {
      ...
      let url = urlString+ 'tasks?completed=false'
      const req = httpMock.expectOne(url) ;
    ...
    it('Should Load Tasks where taskCategoryID is 1', () => {
      ...
      let url = urlString+ 'tasks?taskCategoryID=1'
      const req = httpMock.expectOne(url) ;
    ...
    it('Should load tasks where  Start Date is 04/28/2016', () => {
      ...
      let url = urlString+ 'tasks?startDate=2016-04-28'
      const req = httpMock.expectOne(url) ;
    ...
    it('Should Load tasks where End Date 04/28/2016', () => {
      ...
      let url = urlString+ 'tasks?endDate=2017-05-28'
      const req = httpMock.expectOne(url) ;
    ...
    it('Should load tasks where Schedule Start Date is 11/22/2017', () => {
      ...
      let url = urlString+ 'tasks?scheduledStartDate=2017-11-22'
      const req = httpMock.expectOne(url) ;
    ...
    it('Should load tasks where Schedule End Date is 11/22/2017', () => {
      ...
      let url = urlString+ 'tasks?scheduledEndDate=2017-11-22'
      const req = httpMock.expectOne(url) ;
    ...
    it('Should load tasks where Schedule Equal Date is 11/22/2017', () => {
      ...
      let url = urlString+ 'tasks?scheduledEqualDate=2017-11-22'
      const req = httpMock.expectOne(url) ;
  ...
  describe('scheduleTask() ', function () {
    it('Should Schedule Task', () => {
      ...
      let url = urlString + 'task/schedule';
      const req = httpMock.expectOne(url) ;
  ...
  describe('completeTask() ', function () {
    ...
    it('Should mark task completed', () => {
      ...
      let url = urlString + 'task/complete';
      const req = httpMock.expectOne(url) ;
      let parameters = {
        taskID  : task.taskID,
