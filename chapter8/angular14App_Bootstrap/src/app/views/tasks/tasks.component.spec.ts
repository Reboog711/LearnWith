...
/* Not working on Angular 14' might be this issue: https://github.com/angular/angular/issues/45476
...
*/
      ...
      it('Should open Modal and Edit Existing Task', (done: DoneFn) => {
      ...
      it('Should open Modal but make no changes on dismiss', (done: DoneFn) => {
      ...
      /* Note this didn't work in Angular 14; I had to switch to the done approach
...
describe('onToggleScheduler()', () => {
  ...
  it('should call taskgrid recalculate() after short delay', (done: DoneFn) => {
    component.schedulerState = true;
    component.onToggleScheduler();
    expect(component.schedulerState).toBeFalsy();
    expect(component.gridContainerStyle).toBe('horizontal-layout-94');
