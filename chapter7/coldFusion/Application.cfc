<cfcomponent displayname="ApplicationCFC" output="true" >
    ...
    <cffunction name="onApplicationStart" returntype="boolean" output="true">
        ...
        <cfset application.componentPrefix = "A12.chapter7.coldFusion.">
        <cfset RestInitApplication(expandPath('/A12/chapter7/coldFusion/com/dotComIt/learnWith/services'),"lw7")>
