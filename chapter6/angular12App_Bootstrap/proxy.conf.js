var PROXY_CONFIG = [
  {
    ...
    logLevel: "debug",
    pathRewrite: {
      "^/coldFusion/": "http://local10.angular.learn-with.com/rest/lw6/"
    },
    changeOrigin: true
  },
  {
    ...
    logLevel: "debug",
    pathRewrite: {
      "^/java/": "http://localhost:8086/webapi/"
    }
  },
  {
    context: [
  ...
  },
  {
    ...
    pathRewrite: function (path, req) {
      ...
      let url = resultsArray[0].replace('/php/', 'http://localphp.angular.learn-with.com:8080/A12/chapter6/php/com/dotComIt/learnWith/api/')  ;
